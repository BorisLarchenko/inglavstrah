...
//  find back button in current step div
  const buttonBack16 = form.querySelector('.test__form-wrapper:nth-child(19) .btn-back');
...
//  find back button in current step div
  const buttonBack16Next = form.querySelector('.test__form-wrapper:nth-child(20) .btn-back');
